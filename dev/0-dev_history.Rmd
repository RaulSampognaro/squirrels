...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Package pour analyser les écureuils de central park",
    Description = "Ceci est un exemple de package pour analyser de façon exhaustive les données portant sur les écureuils de central park.",
    `Authors@R` = c(
      person("Raul", "Sampognaro", email = "raul.sampognaro@sciencespo.fr", role = c("aut", "cre"), comment = c(ORCID = "1234-0000-0000-0000"))
    )
  )
)
...
usethis::use_git_remote("origin",
                        url = "https://github.com/RaulSampognaro/squirrels.git",
                        overwrite = TRUE)
...
# Code of Conduct
usethis:: use_code_of_conduct("raul.sampognaro@sciencespo.fr")
# NEWS
usethis::use_news_md()
```
...
```{r, eval=FALSE}
usethis::use_data_raw(name = "nyc_squirrels_sample")
```
